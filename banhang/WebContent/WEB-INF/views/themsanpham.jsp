      ...
      <div class="row">
        <div class="col-md-12" style="margin: 30px">
          <div class="card card-primary">
            <div class="card-body">
				<form method="POST" action="${pageContext.request.contextPath}/them-san-pham">
              ...
              <div class="col-md-6 form-group float-left">
               ...
               <div class="col-md-4 form-group float-left">
                <label for="giavon">Giá vốn:</label>
                 <input type="text" name="giavon" class="form-control" onkeyup="this.value=FormatNumber(this.value);">
              </div>

               <div class="col-md-4 form-group float-left">
                <label for="giaban">Giá bán:</label>
                 <input type="text" name="giaban" class="form-control" onkeyup="this.value=FormatNumber(this.value);">
              </div>

               <div class="col-md-4 form-group float-left">
                <label for="giabuon">Giá buôn:</label>
                 <input type="text" name="giabuon" class="form-control" onkeyup="this.value=FormatNumber(this.value);">
              </div>
