      ...
      <div class="row">
        <div class="col-md-12" style="margin: 30px">
          <div class="card card-primary">
            <div class="card-body">
				<form method="POST" action="${pageContext.request.contextPath}/them-khach-hang">
                <div class="col-md-6 form-group float-left">
                <label>Mã Khách Hàng:</label>
                <input type="text" name="makhachhang" class="form-control">
              </div>
              ...
              <div class="col-md-12 form-group float-left">
                <label for="thuonghieu">Địa chỉ:</label>
                 <textarea type="text" class="form-control" name="diachi"></textarea>
              </div>
              <div class="col-md-12 form-group float-left">
                <label>Ghi chú:</label>
