...
<body class="sidebar-mini sidebar-collapse">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="card-body">
				<form method="POST" action="${pageContext.request.contextPath}/sua-nha-cung-cap">
				<input type="text" name="id" class="form-control" readonly style="display: none" value ="${nhacungcap.idNhaCungCap}">
				<div class="col-md-6 form-group float-left">
                <label for="inputmanhacungcap">Mã nhà cung cấp:</label>
                 <input type="text" name="manhacungcap" class="form-control" value ="${nhacungcap.maNhaCungCap}">
              </div>
               <div class="col-md-6 form-group float-left">
                <label for="inputTenthuonghieu">Tên nhà cung cấp:</label>
                 <input type="text" name="tennhacungcap" class="form-control" value ="${nhacungcap.tenNhaCungCap}">
              </div>
					<div class="col-md-6 form-group float-left">
		               ...
		               <div class="col-md-6 form-group float-left">
		                <label for="inputlienhe">Liên hệ:</label>
		                 <input type="text" name="lienhe" class="form-control" value ="${nhacungcap.lienHe}">
		              </div>
               <div class="col-md-12 form-group float-left">
                <label for="inputGhiChu">Ghi chú:</label>
                 <textarea name="ghichu" class="form-control" rows="2">${nhacungcap.ghiChu}</textarea>
              </div>
   				<div class="row">
